...
export const GlobalProvider = ({ children }) => {
    ...
    // useEffect(() => {                  // <-- Comment out the useEffect hook
    //     getInitialData();
    // }, []); // Runs only once on mount   <-- Comment out the useEffect hook
    ...
    const getInitialData = async () => {
        try {
            ...
            // Keep console.error for actual errors during development
            console.error("Error in (disabled) getInitialData:", error);
        }
    }
